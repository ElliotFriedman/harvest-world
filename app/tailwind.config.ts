...
/** Mirrors `docs/brand-book.md` + former v4 `@theme` tokens */
export default {
  content: [
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        /** Seamless strip: duplicate children, animate -50% */
        marquee: {
      ...
      animation: {
        "harvest-cursor-blink": "harvest-cursor-blink 1060ms steps(1, end) infinite",
