...
export const worldChain: Chain = {
  ...
  rpcUrls: {
    default: { http: ["https://worldchain-mainnet.g.alchemy.com/v2/Qx5oDg17_chloGQLjcca-CQPCcERbmlP"] },
  },
};
...
export const publicClient = createPublicClient({
  chain: worldChain,
  transport: http("https://worldchain-mainnet.g.alchemy.com/v2/Qx5oDg17_chloGQLjcca-CQPCcERbmlP"),
});
